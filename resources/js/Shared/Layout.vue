<template>
    <main>
        <header class="bg-white shadow-base z-50 relative">
            <div class="px-5 flex justify-between mx-auto items-center">
                <div class="flex items-center">
                    ...
                    <a href="/" class="inline-flex font-bold text-xl">
                        <img
                            src="/SeptemberUI.svg"
                            alt="septemberui"
                            width="150"
                ...
                <div>
                    <a href="#" class="font-medium inline-block py-5"
                        >version v1.0.1</a
                    >
                </div>
            </div>
        ...
        <article>
            <div class="flex">
                <div
                    class="h-screen sticky top-0 bg-white w-64 overflow-y-auto"
                    v-if="showNav && !isUrl('')"
                >
                    <div class="py-5 mx-2">
                        <div
                            class="uppercase tracking-wider text-sm px-5 text-gray-500 mb-1 font-bold"
                        >
                            Components
                        </div>
                        <inertia-link
                ...
                <div class="px-6 py-10 flex-1">
                    ...
                    <div
                        class="mt-16 border-t-2 py-6 text-center md:max-w-6xl mx-auto"
                    >
