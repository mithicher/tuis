<template>
    <div>
        ...
        <label
            ...
            :class="[
                {
                    'inline-flex mr-4': stacked == false,
                    'flex w-full': stacked == true
                },
                classes,
                {
                    'border-blue-500':
                        ...
                        customActive == true &&
                        customActiveClass == 'text-blue-500',
                    'border-red-500':
                        modelValue == option.value &&
                        customActive == true &&
                        customActiveClass == 'text-red-500',
                    'border-teal-500':
                        modelValue == option.value &&
                        customActive == true &&
                        customActiveClass == 'text-teal-500'
                }
            ]"
        ...
        >
            <template v-if="customActive == false">
                ...
                <span
                    class="check-toggle flex-shrink-0"
                    :class="sizeClass"
                ></span>
            </template>
        ...
        <small v-if="helpText" class="block text-sm text-gray-600">{{
            helpText
        }}</small>
    </div>
</template>
